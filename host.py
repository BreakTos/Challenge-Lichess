...
AllKeys={}
TOKEN: Final = '6264740670:AAFehzfYvY6jmCiawNayGXrwPGxz3FNry9w' # Replace with your Token
...
if __name__ == '__main__':
    ...
    # Messages
    hi_filter = filters.Regex(r'(?i)^\s*(hi|hii|hello|ya|anyone|chess|Hello|Chess)\s*$')
